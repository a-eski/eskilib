...
{
	// eskilib_test_run("eskilib_list_add_null_element_struct_test", eskilib_list_add_null_element_struct_test);
	
	eskilib_test_run("eskilib_list_add_null_list_struct_test", eskilib_list_add_null_list_struct_test);
}
...
void eskilib_list_struct_tests(void)
{
	...
	eskilib_test_run("eskilib_list_malloc_default_size_struct_test", eskilib_list_malloc_default_size_struct_test);
	
	eskilib_test_run("eskilib_list_malloc_nondefault_size_struct_test", eskilib_list_malloc_nondefault_size_struct_test);
	
	eskilib_test_run("eskilib_list_add_one_element_struct_test", eskilib_list_add_one_element_struct_test);

	eskilib_test_run("eskilib_list_add_until_size_expanded_struct_test", eskilib_list_add_until_size_expanded_struct_test);

	eskilib_test_run("eskilib_list_add_10_struct_test", eskilib_list_add_10_struct_test);
}
