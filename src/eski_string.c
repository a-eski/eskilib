...
eski_nodiscard bool eski_string_equals(char *stringOne, char *stringTwo, const size_t maxStringSize)
{
...
eski_nodiscard int_fast32_t eski_string_compare(char *stringOne, char *stringTwo, const size_t maxStringSize)
{
    assert(stringOne != NULL);
    assert(stringTwo != NULL);
    if (maxStringSize == 0)
...
eski_nodiscard bool eski_string_contains_unsafe(const char *string, const char *substring)
{
    assert(string != NULL);
...
eski_nodiscard bool eski_string_contains(const struct eski_String string,
                                               const struct eski_String substring)
{
...
eski_nodiscard bool eski_string_contains_s(const char *string, size_t string_length,
                                                 const struct eski_String substring)
{
    assert(string != NULL);
    assert(substring.value != NULL);
...
eski_nodiscard bool eski_string_contains_s2(const char *string, size_t string_length, const char *string_two,
