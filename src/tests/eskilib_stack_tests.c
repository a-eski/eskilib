...
void eskilib_stack_tests(void)
{
	...
	eskilib_test_run(eskilib_stack_malloc_test);

	eskilib_test_run(eskilib_stack_push_empty_stack_test);

	eskilib_test_run(eskilib_stack_push_nonempty_stack_test);

	eskilib_test_run(eskilib_stack_push_full_stack_test);

	eskilib_test_run(eskilib_stack_pop_empty_stack_test);

	eskilib_test_run(eskilib_stack_pop_test);

	eskilib_test_run(eskilib_stack_pop_multiple_test);
