...
void eskilib_queue_tests(void)
{
	...
	eskilib_test_run(eskilib_queue_malloc_test);

	eskilib_test_run(eskilib_queue_enqueue_empty_queue_test);

	eskilib_test_run(eskilib_queue_enqueue_nonempty_queue_test);

	eskilib_test_run(eskilib_queue_dequeue_empty_queue_test);

	eskilib_test_run(eskilib_queue_dequeue_nonempty_queue_to_empty_queue_test);

	eskilib_test_run(eskilib_queue_dequeue_nonempty_queue_test);
